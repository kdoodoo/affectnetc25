...
When analyze our derived models, Cite the original models/papers accordingly as we note 'Model References' at the below. 
...
---
### Model References :
We refer the models/papers accordingly for the academic use.
